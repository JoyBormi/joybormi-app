    ...
    >
      ...
      >
        <Animated.View
          ...
          className="w-full max-w-sm overflow-hidden rounded-[32px] border border-white/20 shadow-2xl"
        >
          <BlurView
            intensity={Platform.OS === 'ios' ? 60 : 100}
            tint="light"
            className="p-8 bg-white/60"
          >
            {/* Close Button */}
            <Pressable
              onPress={() => setIsVisible(false)}
              className="absolute right-4 top-4 z-10 p-2 rounded-full bg-purple-500/10"
              hitSlop={20}
            >
            ...
            <View className="items-center">
              ...
              <View className="bg-purple-100 rounded-full p-6 mb-6 shadow-inner">
                <WifiOff size={36} color="#8A70D6" strokeWidth={1.5} />
              </View>
              ...
              {/* Status Indicator */}
              <View className="flex-row items-center bg-white/40 border border-purple-200/50 px-4 py-2 rounded-2xl">
                <View className="w-2 h-2 rounded-full bg-purple-400 mr-3 animate-pulse" />
