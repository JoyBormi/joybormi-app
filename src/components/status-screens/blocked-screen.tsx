  ...
  return (
    <View className="flex-1 bg-background justify-center items-center p-6">
      ...
      >
        <View
          className={cn(
            'overflow-hidden rounded-3xl border border-destructive/50',
            'bg-card/50 backdrop-blur-xl',
            'shadow-lg',
          )}
        >
          {/* Header Strip */}
          <View className="bg-destructive/20 border-b border-destructive/30 p-4 flex-row items-center gap-2">
          ...
          <View className="p-6 items-center">
            ...
            {onContactSupport && (
              ...
              >
                <Text className="font-title text-white">
